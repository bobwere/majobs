...
//
//     final spNewJobs = spNewJobsFromJson(jsonString);

import 'dart:convert';

SpNewJobs spNewJobsFromJson(String str) => SpNewJobs.fromJson(json.decode(str));

String spNewJobsToJson(SpNewJobs data) => json.encode(data.toJson());
...
class SpNewJobs {
  ...
  factory SpNewJobs.fromJson(Map<String, dynamic> json) => SpNewJobs(
        newJobs: json["newJobs"] == null
            ? null
            : List<NewJob>.from(json["newJobs"].map((x) => NewJob.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "newJobs": newJobs == null
            ? null
            : List<dynamic>.from(newJobs.map((x) => x.toJson())),
      };
}
