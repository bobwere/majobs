...
//
//     final spUnpaidJobs = spUnpaidJobsFromJson(jsonString);

import 'dart:convert';

SpUnpaidJobs spUnpaidJobsFromJson(String str) =>
    SpUnpaidJobs.fromJson(json.decode(str));

String spUnpaidJobsToJson(SpUnpaidJobs data) => json.encode(data.toJson());
...
class SpUnpaidJobs {
  ...
  List<UnpaidJob> unpaidJobs;

  SpUnpaidJobs copyWith({
    List<UnpaidJob> unpaidJobs,
  }) =>
      SpUnpaidJobs(
        unpaidJobs: unpaidJobs ?? this.unpaidJobs,
      );

  factory SpUnpaidJobs.fromJson(Map<String, dynamic> json) => SpUnpaidJobs(
        unpaidJobs: json["unpaidJobs"] == null
            ? null
            : List<UnpaidJob>.from(
                json["unpaidJobs"].map((x) => UnpaidJob.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "unpaidJobs": unpaidJobs == null
            ? null
            : List<dynamic>.from(unpaidJobs.map((x) => x.toJson())),
      };
}
...
class UnpaidJob {
  ...
  factory UnpaidJob.fromJson(Map<String, dynamic> json) => UnpaidJob(
